...
- Review contract: default single generates only matches (multiple disjoint citations per requirement), comment and questions. Build internal IDs in Go; do not require Resume/contact extraction. Normalize structured fields without substring checks; validate verbatim quotes separately. No 24-requirement or 16-line citation caps. Keep resource budgets explicit and never equate provenance validation with semantic accuracy. See docs/review-fixes-2026-09-21.md.
