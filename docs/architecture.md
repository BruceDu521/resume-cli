...
PDF 20 MiB、文本 160 KiB、JD 64 KiB、序列化模型输入 200 KiB、AI 响应 2 MiB。超过资源限制明确报错，不按技能或要求条数截断。HTTP 单次 60s，命令默认 90s；429/529/502/503/504 最多三次，取消传播，不重试不明网络故障或 401。HTTPS 且禁止重定向。
